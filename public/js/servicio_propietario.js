...
let registrarPropietario = (pavatar, pnombre, psnombre, pgenero, pcorreo, pcontrasena, pid, pprimer_apellido, psegundo_apellido, pfecha, pdireccion_exacta, pprovincia, pcanton, pdistrito, ptipo_usuario) => {
    axios({
        method: 'post',
